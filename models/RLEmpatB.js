...
export const rlEmpatBHeader = databaseSIRS.define("rl_empat_b", {
  rs_id: {
...
export const rlEmpatBDetail = databaseSIRS.define("rl_empat_b_detail", {
  rl_empat_b_id: {
    type: DataTypes.INTEGER,
  },
  rs_id: {
...
export const rlEmpatJenisGolPenyakit = databaseSIRS.define(
...
rlEmpatBHeader.hasMany(rlEmpatBDetail, { foreignKey: "rl_empat_b_id" });
rlEmpatBDetail.belongsTo(rlEmpatBHeader, { foreignKey: "id" });

rlEmpatJenisGolPenyakit.hasMany(rlEmpatBDetail, { foreignKey: "id" });
rlEmpatBDetail.belongsTo(rlEmpatJenisGolPenyakit, {
  foreignKey: "jenis_golongan_penyakit_id",
});
