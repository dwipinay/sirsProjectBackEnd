...
export const rlEmpatAHeader = databaseSIRS.define("rl_empat_a", {
  rs_id: {
...
export const rlEmpatADetail = databaseSIRS.define("rl_empat_a_detail", {
  rl_empat_a_id: {
    type: DataTypes.INTEGER,
  },
  rs_id: {
...
rlEmpatAHeader.hasMany(rlEmpatADetail, {
  foreignKey: "rl_empat_a_id",
});
rlEmpatADetail.belongsTo(rlEmpatAHeader, {
  foreignKey: "id",
});

jenisGolSebabPenyakitId.hasMany(rlEmpatADetail, {
  foreignKey: "id",
});
rlEmpatADetail.belongsTo(jenisGolSebabPenyakitId, {
